...
class TbcCharacterInventory(models.Model):
...
class TbcCharacterQueststatus(models.Model):
...
class TbcCharacterQueststatusDaily(models.Model):
    guid = models.PositiveIntegerField(primary_key=True)
    quest = models.PositiveIntegerField()
...
class TbcCharacterQueststatusMonthly(models.Model):
    guid = models.PositiveIntegerField(primary_key=True)
    quest = models.PositiveIntegerField()
...
class TbcCharacterQueststatusWeekly(models.Model):
    guid = models.PositiveIntegerField(primary_key=True)
    quest = models.PositiveIntegerField()
...
class TbcCharacterReputation(models.Model):
    guid = models.PositiveIntegerField(primary_key=True)
...
class TbcCharacterSpell(models.Model):
    guid = models.PositiveIntegerField(primary_key=True)
...
class TbcCharacters(models.Model):
    guid = models.PositiveIntegerField(primary_key=True)
...
class TbcItemInstance(models.Model):
    guid = models.PositiveIntegerField(primary_key=True)
...
class TbcMailItems(models.Model):
...
class TbcPvpstatsPlayers(models.Model):
