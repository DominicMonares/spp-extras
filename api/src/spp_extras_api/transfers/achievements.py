...
from spp_extras_api.utils.ach_credit import create_ach_credit_args
from spp_extras_api.utils.ach_prog import create_ach_prog_args
...
def transfer_achievements(accounts, char_ids, send_msg, bots):
    ...
    # ----------------------------------------------------------------
    # Create db query arguments
    # ----------------------------------------------------------------

    # Run progress transfer and add any new achievements in all_acct_data
    try:
        send_msg('Creating achievement progress arguments...')
        ...
        send_msg('Achievement progress arguments successfully created!')
    except Exception as e:
        send_msg('Failed to create achievement progress arguments!')
        send_msg(f'Error: {e}')
        return

    # Run credit transfer which runs reward transfers
    try:
        send_msg('Creating achievement credit and reward arguments...')
        ...
        send_msg('Achievement credit and reward arguments successfully created!')
    except Exception as e:
        send_msg('Failed to create achievement credit and reward arguments!')
        send_msg(f'Error: {e}')
        return
