...
def format_all_acct_data(accounts, ach_credit, ach_char_prog, ach_shared_prog, completed_quests):
    ...
    for acct_id in accounts:
        ...
        all[acct_id]['characters'] = merged_chars
        chars = all[acct_id]['characters']
        ...
        for char_id in chars:
            ...
            if valid_player_char or valid_bot_char:
                all[acct_id]['characters'][char_id]['credit'] = {}
                if char_id in ach_credit:
                    for ach_id in ach_credit[char_id]:
                        ...
                        all[acct_id]['characters'][char_id]['credit'] = char_credit

                # Add to account-wide quest credit
                all[acct_id]['characters'][char_id]['quests'] = {}
        ...
        all[acct_id]['credit'] = credit
        all[acct_id]['shared_progress'] = shared_progress
        all[acct_id]['quests'] = quests
