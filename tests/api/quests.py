...
class TestFormatCompletedQuests(TestCase):
    ...
    def test_format_completed(self):
        ...
        with open(from_root('tests/samples/rawData/rawCompletedQuests.json'), 'r') as json_file:
...
class TestFormatTemplateQuests(TestCase):
    ...
    def test_format_template(self):
        with open(from_root('tests/samples/rawData/rawTemplateQuests.json'), 'r') as json_file:
